# Parameter sources for the multi-collateral DAI simulation
...
`docs/calibration/parameter_estimation.md`. It defines parameter
...
### 2.1 Representative vault-evidence design
...
[`docs/calibration/vaults.md`](vaults.md).
