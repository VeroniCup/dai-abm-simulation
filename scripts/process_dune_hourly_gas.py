...
try:
    from acquire_dune_hourly_gas import (
    ...
    from process_dune_market_prices import sha256_file
except ImportError:  # pragma: no cover - package-style imports in tests
    from scripts.acquire_dune_hourly_gas import (
        EXPECTED_COLUMNS as RAW_GAS_COLUMNS,
        FULL_END,
        FULL_START,
        LONDON_HOUR,
    ...
    from scripts.process_dune_market_prices import sha256_file
