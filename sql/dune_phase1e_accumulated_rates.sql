...
rates AS (
    ...
    WHERE d.call_block_date >= DATE '2019-11-01'
      AND d.call_block_date < DATE '2024-07-01'
      AND d.call_block_time >= TIMESTAMP '2019-11-01 00:00:00 UTC'
      AND d.call_block_time < TIMESTAMP '2024-07-01 00:00:00 UTC'
    ...
    WHERE f.call_block_date >= DATE '2019-11-01'
      AND f.call_block_date < DATE '2024-07-01'
      AND f.call_block_time >= TIMESTAMP '2019-11-01 00:00:00 UTC'
      AND f.call_block_time < TIMESTAMP '2024-07-01 00:00:00 UTC'
