...
transactions AS (
    ...
    WHERE block_date >= DATE '2019-12-01'
      AND block_date < DATE '2020-01-01'
...
mutations AS (
    ...
    WHERE f.call_block_date >= DATE '2019-12-01'
      AND f.call_block_date < DATE '2020-01-01'
    ...
    WHERE g.call_block_date >= DATE '2019-12-01'
      AND g.call_block_date < DATE '2020-01-01'
