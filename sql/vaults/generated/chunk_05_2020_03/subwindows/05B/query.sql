...
transactions AS (
    ...
    WHERE block_date >= DATE '2020-03-16'
      AND block_date < DATE '2020-04-01'
      AND block_time >= TIMESTAMP '2020-03-16 00:00:00 UTC'
      AND block_time < TIMESTAMP '2020-04-01 00:00:00 UTC'
),
mutations AS (
    SELECT
    ...
    WHERE f.call_block_date >= DATE '2020-03-16'
      AND f.call_block_date < DATE '2020-04-01'
      AND f.call_block_time >= TIMESTAMP '2020-03-16 00:00:00 UTC'
      AND f.call_block_time < TIMESTAMP '2020-04-01 00:00:00 UTC'
    ...
    WHERE g.call_block_date >= DATE '2020-03-16'
      AND g.call_block_date < DATE '2020-04-01'
      AND g.call_block_time >= TIMESTAMP '2020-03-16 00:00:00 UTC'
      AND g.call_block_time < TIMESTAMP '2020-04-01 00:00:00 UTC'
