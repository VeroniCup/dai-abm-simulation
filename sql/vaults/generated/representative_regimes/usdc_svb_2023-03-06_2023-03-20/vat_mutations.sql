...
transactions AS (
    ...
    WHERE block_date >= DATE '2023-03-06'
      AND block_date < DATE '2023-03-20'
      AND block_time >= TIMESTAMP '2023-03-06 00:00:00 UTC'
      AND block_time < TIMESTAMP '2023-03-20 00:00:00 UTC'
),
mutations AS (
    SELECT
    ...
    WHERE f.call_block_date >= DATE '2023-03-06'
      AND f.call_block_date < DATE '2023-03-20'
      AND f.call_block_time >= TIMESTAMP '2023-03-06 00:00:00 UTC'
    ...
    WHERE g.call_block_date >= DATE '2023-03-06'
      AND g.call_block_date < DATE '2023-03-20'
      AND g.call_block_time >= TIMESTAMP '2023-03-06 00:00:00 UTC'
