...
transactions AS (
    ...
    WHERE block_date >= DATE '2024-02-01'
      AND block_date < DATE '2024-03-01'
      AND block_time >= TIMESTAMP '2024-02-01 00:00:00 UTC'
...
mutations AS (
    ...
    WHERE f.call_block_date >= DATE '2024-02-01'
      AND f.call_block_date < DATE '2024-03-01'
      AND f.call_block_time >= TIMESTAMP '2024-02-01 00:00:00 UTC'
    ...
    WHERE g.call_block_date >= DATE '2024-02-01'
      AND g.call_block_date < DATE '2024-03-01'
      AND g.call_block_time >= TIMESTAMP '2024-02-01 00:00:00 UTC'
      AND g.call_block_time < TIMESTAMP '2024-03-01 00:00:00 UTC'
