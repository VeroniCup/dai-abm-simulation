...
def semantic_audit() -> pd.DataFrame:
    ...
    liquidation = (PROJECT_ROOT / "src/liquidation.py").read_text(encoding="utf-8")
    vault = (PROJECT_ROOT / "src/vault.py").read_text(encoding="utf-8")
    required = (
    ...
    metadata = {
        ...
        "source_checksums": {
            ...
            "liquidation_implementation": sha256_file(
                PROJECT_ROOT / "src/liquidation.py"
            ),
            "vault_implementation": sha256_file(PROJECT_ROOT / "src/vault.py"),
        },
        "substantive_counts": {
