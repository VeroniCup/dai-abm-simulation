...
def test_restructuring_cases_are_the_only_collection_additions() -> None:
    ...
    assert counts == {
        ...
        "tests/calibration/test_tracked_calibration_evidence.py": 7,
        ...
        "tests/calibration/test_simulated_moments.py": 13,
        "tests/calibration/test_simulated_moments_search.py": 21,
        "tests/calibration/test_simulated_moments_diagnostics.py": 30,
        "tests/model/test_confidence.py": 10,
        "tests/model/test_market.py": 7,
        "tests/workflows/test_confidence_calibration.py": 27,
    }
